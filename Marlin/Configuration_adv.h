...
#if ENABLED(CREMAKER_CHAMBER)
  #define E1_AUTO_FAN_PIN PB6      //cremaker chamber auto fan
#else
...
//#define CASE_LIGHT_ENABLE
  ...
  #define CASE_LIGHT_PIN PB4                  // Override the default pin if needed
...
#define LIN_ADVANCE
  ...
  //#define LIN_ADVANCE_K 0.068 //cremaker M V2, 0.6 nozzle    
  #define LIN_ADVANCE_K 0.085 //cremaker M V2, 0.4 nozzle    
 ...
 */
  ...
  // Note: this values cannot be calibrated and have to be set manually
    ...
    #define PTC_PARK_POS   { 220, 220, 100 }

    // Probe position to probe and wait for probe to reach target temperature
    #define PTC_PROBE_POS  { 110, 110 }
    ...
    #define PTC_SAMPLE_RES    2
    #define PTC_SAMPLE_COUNT  7U

    #define PTC_SAMPLE_START_WINTER  25 
    #define PTC_SAMPLE_RES_WINTER    2
    #define PTC_SAMPLE_COUNT_WINTER  4U

    // Bed temperature calibration builds a similar table.

    //#define BTC_SAMPLE_START  60.0f
    //#define BTC_SAMPLE_RES    5.0f
    //#define BTC_SAMPLE_COUNT  5U

    // The temperature the probe should be at while taking measurements during bed temperature
    // calibration.
    #define BTC_PROBE_TEMP 30

    #define BTC_PROBE_TEMP_WINTER 25

    // Height above Z=0.0f to raise the nozzle. Lowering this can help the probe to heat faster.
    // Note: the Z=0.0f offset is determined by the probe offset which can be set using M851.
    #define PTC_PROBE_HEATING_OFFSET 0.0f
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_ACCEL       125  // (mm/s^2) Lower acceleration may allow a faster feedrate.
